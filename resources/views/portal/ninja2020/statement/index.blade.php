    ...
    <div class="flex flex-col md:flex-row md:justify-between">
        <div class="flex flex-col md:flex-row md:items-center">
            <div class="flex">
                <label for="from" class="block w-full flex items-center mr-4">
                    ...
                    <input id="date-from" type="date" class="input w-full mt-0" data-field="startDate"
                ...
                <label for="to" class="block w-full flex items-center mr-4">
                    ...
                    <input id="date-to" type="date" class="input w-full mt-0" data-field="endDate"
            ...
            <label for="show_status" class="block w-4/5 flex items-center mr-4">
                ...
                <select id="status" name="status" class="input w-full mt-0 form-select">
        ...
        <div>
            <label for="show_payments" class="block flex items-center mr-4 mt-4 md:mt-0">
                <input id="show-payments-table" type="checkbox" data-field="showPaymentsTable" class="form-checkbox"
                    autocomplete="off">
            ...
            <label for="show_aging" class="block flex items-center">
                <input id="show-aging-table" type="checkbox" data-field="showAgingTable" class="form-checkbox"
                    autocomplete="off">
        ...
        <button
            ...
            id="pdf-download" class="button button-primary bg-primary mt-4 md:mt-0">{{ ctrans('texts.download') }}</button>
    </div>
