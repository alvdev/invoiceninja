                ...
                <div class="grid grid-cols-6 gap-6 max-w-4xl">
                    ...
                    <div class="col-span-6 sm:col-span-4 flex items-center">
                        ...
                        <div class="radio mr-4">
                            <input class="form-radio cursor-pointer" type="radio" value="US" name="country"
                                checked wire:model.defer="country">
                    ...
                    @if ($country == 'CA')
                        <div class="col-span-6 sm:col-span-4 {{ $country != 'CA' ? 'hidden' : 'block' }}">
                            ...
                            <div class="checkbox">
                                <input class="form-checkbox cursor-pointer mr-2" type="checkbox" name="debit_cards"
                                    value="1" wire:model.defer="debit_cards">
                    ...
                    @if ($country == 'US')
                        <div class="col-span-6 sm:col-span-4 {{ $country != 'US' ? 'hidden' : 'block' }}">
                            ...
                            <div class="checkbox">
                                <input class="form-checkbox cursor-pointer mr-2" type="checkbox" name="ach"
                                    value="1" wire:model="ach">
                    ...
                    <div class="col-span-6 sm:col-span-4">
                        ...
                        <div class="checkbox">
                            <input class="form-checkbox cursor-pointer mr-2" type="checkbox"
                                name="wepay_payment_tos_agree" value="1"
                                wire:model.defer="wepay_payment_tos_agree">
