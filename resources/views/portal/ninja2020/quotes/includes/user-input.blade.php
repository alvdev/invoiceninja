<div style="display: none;" id="displayInputModal"
    ...
    <div x-show="open" x-transition:enter="ease-out duration-300"
            ...
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mx-auto max-w-xs space-y-5 py-5">
                    <input name="user_input" id="user_input"
                        ...
                        placeholder="{{ ctrans('texts.po_number') }}" type="text">
                </div>
        ...
        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            <div class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto">
                <button type="button" id="input-next-step" class="button button-primary bg-primary whitespace-nowrap"
                    @click="document.getElementById('displayInputModal').style.display = 'none';">
