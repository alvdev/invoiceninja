    ...
    @if (session()->has('missing_required_fields'))
        <div class="validation validation-fail">
            ...
            <button onclick="window.history.back();"
                class="block mt-3 button button-link pl-0 ml-0 underline">{{ ctrans('texts.after_completing_go_back_to_previous_page') }}</button>
        </div>
    @endif
    ...
    <div class="mt-2 sm:mt-6">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form action="{{ route('vendor.profile.update', ['vendor_contact' => $contact->hashed_id]) }}"
                    method="post" id="saveVendor">
                    @csrf
                    @method('PUT')
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="px-4 py-5 bg-white sm:p-6">
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <input id="address1"
                                class="input w-full {{ in_array('billing_address1', (array) session('missing_required_fields')) ? 'border border-red-400' : '' }}"
                                name="address1" value="{{ $vendor->address1 }}" />
                            @error('address1')
                                <div class="validation validation-fail">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input id="address2"
                                class="input w-full {{ in_array('billing_address2', (array) session('missing_required_fields')) ? 'border border-red-400' : '' }}"
                                name="address2" value="{{ $vendor->address2 }}" />
                            @error('address2')
                                <div class="validation validation-fail">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input id="city"
                                class="input w-full {{ in_array('billing_city', (array) session('missing_required_fields')) ? 'border border-red-400' : '' }}"
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <input id="state"
                                class="input w-full {{ in_array('billing_state', (array) session('missing_required_fields')) ? 'border border-red-400' : '' }}"
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <input id="postal_code"
                                class="input w-full {{ in_array('billing_postal_code', (array) session('missing_required_fields')) ? 'border border-red-400' : '' }}"
                                name="postal_code" value="{{ $vendor->postal_code }}" />
                            @error('postal_code')
                                <div class="validation validation-fail">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-span-6 sm:col-span-2">
                            ...
                            <select id="country"
                                class="input w-full bg-white form-select {{ in_array('billing_country', (array) session('missing_required_fields')) ? 'border border-red-400' : '' }}"
                                value="{{ $vendor->country_id }}" name="country_id">
                        ...
                        <div class="col-span-6 sm:col-span-6">
                            ...
                            <textarea rows="4" id="public_notes"
                                ...
                                name="public_notes" value="{{ $vendor->public_notes }}" />{{ $vendor->public_notes }}</textarea>
                            @error('public_notes')
                                <div class="validation validation-fail">
                                    {{ $message }}
                                </div>
                ...
                <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                    <button type="submit"
                        class="button button-primary bg-primary whitespace-nowrap">{{ ctrans('texts.save') }}</button>
                </div>
            </div>
            </form>
        </div>
