    ...
    <div x-show="open" x-transition:enter="ease-out duration-300"
        ...
        <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
            <div class="flex w-full rounded-md shadow-sm sm:ml-3 sm:w-auto" x-data>
                <button type="button" id="signature-next-step"
            ...
            <div class="mt-3 flex w-full rounded-md shadow-sm sm:mt-0 sm:w-auto" x-data>
                <button @click="document.getElementById('displaySignatureModal').style.display = 'none';" type="button"
                    class="button button-secondary" id="close-button">
                    {{ ctrans('texts.close') }}
                </button>
            </div>
        </div>
