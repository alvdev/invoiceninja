            ...
            <div class="flex flex-col">
                ...
                <form action="{{ route('password.email') }}" method="post" class="mt-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input type="email" name="email" id="email" class="input" placeholder="user@example.com"
                    ...
                    <div class="mt-5">
                        <button
                            class="button button-primary button-block bg-blue-600">{{ ctrans('texts.next_step') }}</button>
                    </div>
                </form>
            </div>
        </div>
